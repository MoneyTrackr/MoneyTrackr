...
from application.views import income, expense, home, income_new, income_edit,income_delete, expense_delete, expense_new, expense_edit
...
urlpatterns = patterns('',
    ...
    url(r'^income/(\d+)/delete', income_delete),
